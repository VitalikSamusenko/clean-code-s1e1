...
var taskInput=document.querySelector(".create-task__input-text");//Add a new task.
var addButton=document.querySelector(".create-task__button");//first button
var incompleteTaskHolder=document.querySelector(".incomplete__tasks-list");//ul of #  incompleteTasks
...
var createNewTaskElement=function (taskString) {
    ...
    listItem.className="incomplete__tasks-list-item list-item";
...
var editTask=function () {
    ...
    var containsClass=listItem.classList.contains("incomplete__tasks-list-item_edit-mode");
    ...
    listItem.classList.toggle("incomplete__tasks-list-item_edit-mode");
};
